 ...
 */
package br.com.tinnovatest.config;

import br.com.tinnovatest.domain.commons.exception.ApiError;
import br.com.tinnovatest.domain.commons.exception.ErrorMessageEnum;
import br.com.tinnovatest.domain.commons.exception.InvalidParameterException;
...
public class CustomResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleAccessDeniedException(final Exception ex, final WebRequest request) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(new ApiError(null, "Acesso Negado!"));
    }
    ...
    public ResponseEntity<ApiError> handlerPreConditionException(final NotAllowException ex) {
